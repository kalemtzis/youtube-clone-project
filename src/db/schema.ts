...
export const playlistVisiblity = pgEnum("playlist_visibility", [
  "private",
  "public",
]);
...
export const playlists = pgTable("playlists", {
  ...
  userId: uuid("user_id")
    ...
    .notNull(),
  //visibility: playlistVisiblity("visibility").default("private").notNull(),
  createdAt: timestamp("created_at").defaultNow().notNull(),
  updatedAt: timestamp("updated_at").defaultNow().notNull(),
});
...
export const commentReactionsRelations = relations(
  ...
  ({ one }) => ({
    user: one(users, {
      ...
      references: [users.id],
      relationName: "comment_reactions_viewer_id_fk",
    }),
